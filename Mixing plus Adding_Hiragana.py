...
input_text = """1三日(にち)目(め)に、ガリラヤのカナで婚礼(こんれい)があって、イエスの母(はは)がそこにいた。 2イエスも、その弟子(でし)たちも婚礼(こんれい)に招(まね)かれた。 3ぶどう酒(しゅ)が足(た)りなくなったので、母(はは)がイエスに、「ぶどう酒(しゅ)がなくなりました」と言(い)った。 4イエスは母(はは)に言(い)われた。「婦人(ふじん)よ、わたしとどんなかかわりがあるのです。わたしの時(とき)はまだ来(き)ていません。」 5しかし、母(はは)は召(め)し使(つか)いたちに、「この人(ひと)が何(なに)か言(い)いつけたら、そのとおりにしてください」と言(い)った。 6そこには、ユダヤ(ゆだや)人(じん)が清(きよ)めに用(もち)いる石(いし)の水(みず)がめが六(むっ)つ置(お)いてあった。いずれも二ないし三メトレテス入(はい)りのものである。 7イエスが、「水(みず)がめに水(みず)をいっぱい入(い)れなさい」と言(い)われると、召(め)し使(つか)いたちは、かめの縁(えん)まで水(みず)を満(み)たした。 8イエスは、「さあ、それをくんで宴会(えんかい)の世話(せわ)役(やく)のところへ持(も)って行(い)きなさい」と言(い)われた。召(め)し使(つか)いたちは運(はこ)んで行(い)った。 9世話(せわ)役(やく)はぶどう酒(しゅ)に変(か)わった水(みず)の味見(あじみ)をした。このぶどう酒(しゅ)がどこから来(き)たのか、水(みず)をくんだ召(め)し使(つか)いたちは知(し)っていたが、世話(せわ)役(やく)は知(し)らなかったので、花婿(はなむこ)を呼(よ)んで、 10言(い)った。「だれでも初(はじ)めに良(よ)いぶどう酒(さけ)を出(だ)し、酔(よ)いがまわったころに劣(おと)ったものを出(だ)すものですが、あなたは良(よ)いぶどう酒(しゅ)を今(いま)まで取(と)って置(お)かれました。」 11イエスは、この最初(さいしょ)のしるしをガリラヤのカナで行(い)って、その栄光(えいこう)を現(あらわ)された。それで、弟子(でし)たちはイエスを信(しん)じた。
12この後(あと)、イエスは母(はは)、兄弟(きょうだい)、弟子(でし)たちとカファルナウムに下(くだ)って行(い)き、そこに幾日(いくにち)か滞在(たいざい)された。
13ユダヤ(ゆだや)人(じん)の過越(すぎこし)祭(さい)が近(ちか)づいたので、イエスはエルサレムへ上(あが)って行(い)かれた。 14そして、神殿(しんでん)の境内(けいだい)で牛(うし)や羊(ひつじ)や鳩(はと)を売(う)っている者(もの)たちと、座(すわ)って両替(りょうがえ)をしている者(もの)たちを御覧(ごらん)になった。 15イエスは縄(なわ)で鞭(むち)を作(つく)り、羊(ひつじ)や牛(うし)をすべて境内(けいだい)から追(お)い出(だ)し、両替(りょうがえ)人(じん)の金(きん)をまき散(ち)らし、その台(だい)を倒(たお)し、 16鳩(ばと)を売(う)る者(もの)たちに言(い)われた。「このような物(もの)はここから運(はこ)び出(だ)せ。わたしの父(ちち)の家(いえ)を商売(しょうばい)の家(いえ)としてはならない。」 17弟子(でし)たちは、「あなたの家(いえ)を思(おも)う熱意(ねつい)がわたしを食(く)い尽(つ)くす」と書(か)いてあるのを思(おも)い出(だ)した。 18ユダヤ(ゆだや)人(じん)たちはイエスに、「あなたは、こんなことをするからには、どんなしるしをわたしたちに見(み)せるつもりか」と言(い)った。 19イエスは答(こた)えて言(い)われた。「この神殿(しんでん)を壊(こわ)してみよ。三日(にち)で建(た)て直(なお)してみせる。」 20それでユダヤ(ゆだや)人(じん)たちは、「この神殿(しんでん)は建(た)てるのに四十六年(ねん)もかかったのに、あなたは三日(にち)で建(た)て直(なお)すのか」と言(い)った。 21イエスの言(い)われる神殿(しんでん)とは、御自分(ごじぶん)の体(からだ)のことだったのである。 22イエスが死者(ししゃ)の中(なか)から復活(ふっかつ)されたとき、弟子(でし)たちは、イエスがこう言(い)われたのを思(おも)い出(だ)し、聖書(せいしょ)とイエスの語(かた)られた言葉(ことば)とを信(しん)じた。
23イエスは過越(すぎこし)祭(さい)の間(あいだ)エルサレムにおられたが、そのなさったしるしを見(み)て、多(おお)くの人(ひと)がイエスの名(な)を信(しん)じた。 24しかし、イエス御自身(ごじしん)は彼(かれ)らを信用(しんよう)されなかった。それは、すべての人(ひと)のことを知(し)っておられ、 25人(にん)間(かん)についてだれからも証(あか)ししてもらう必要(ひつよう)がなかったからである。イエスは、何(なに)が人間(にんげん)の心(こころ)の中(なか)にあるかをよく知(し)っておられたのである。
